...
exports.define('help', function(master, sock){
  sock.title('Commands');
  Object.keys(exports).forEach(function(cmd){
...
exports.define('spawn', function(master, sock, n){
  n = n || 1;
...
exports.define('pids', function(master, sock){
  sock.title('pids');
...
exports.define('kill', function(master, sock, id, signal){
  var worker = master.children[id];
  if (worker) {
    worker.proc.kill(signal);
    sock.write('sent ' + (signal || 'SIGTERM') + ' to worker #' + id + '\n');
  } else {
